...
void define_animated_teapot(void) {
	...
	teapot.material[0].ambient = glm::vec4(0.1745f, 0.01175f, 0.01175f, 1.0f);
	teapot.material[0].diffuse = glm::vec4(0.61424f, 0.04136f, 0.04136f, 1.0f);
	teapot.material[0].specular = glm::vec4(0.727811f, 0.626959f, 0.626959f, 1.0f);
	teapot.material[0].exponent = 128.0f*0.6;
...
void draw_animated_tiger(int cam_index) {
	...
	else if (tiger_time >= 90 && tiger_time < 150)
	{
		//ModelViewMatrix = glm::rotate(ViewMatrix[cam_index], -90*TO_RADIAN, glm::vec3(0.0f, 0.0f, 1.0f));
		ModelViewMatrix = glm::rotate(ViewMatrix[cam_index], tiger_data.rotation_angle, glm::vec3(0.0f, 0.0f, 1.0f));
		ModelViewMatrix = glm::translate(ModelViewMatrix, glm::vec3(100.0f + tiger_time - 90, 100.0f, 1.0f));
...
//	ModelViewMatrix = glm::rotate(ViewMatrix[cam_index], -teapot_rotation_angle, glm::vec3(0.0f, 0.0f, 1.0f));
	...
	//ModelViewMatrix = glm::rotate(ViewMatrix[cam_index], -teapot_rotation_angle, glm::vec3(0.0f, 0.0f, 1.0f));
	ModelViewMatrix = glm::translate(ViewMatrix[cam_index], glm::vec3(150.0f, 150.0f, 1.0f));
	ModelViewMatrix = glm::rotate(ModelViewMatrix, -teapot_rotation_angle, glm::vec3(0.0f, 0.0f, 1.0f));
	...
	glUniform3f(loc_primitive_color,teapot.material[0].diffuse.r,
		tiger[tiger_data.cur_frame].material[0].diffuse.g, teapot.material[0].diffuse.b);
